...
| 当前多层 SIMD | 0.13980 |
| 多层标量 | 0.22225 |
| 相同原生实现的单层 SIMD | 0.11625 |
| 按机器人半径复制三套表 | 0.24585 |
| NumPy 全量 AABB 扫描 | 2.62975 |
| 使用 Q+U 精确 AABB 的多层 SIMD | 0.13900 |
...
精确 Q+U AABB 相比原外包椭球 AABB 的候选减少比例中位数为 6.67%；此批数据的查询耗时改善很小。
...
|---|---:|---:|---:|---:|
| 0 / 141 | 4.637 | 8.193 | 10.924 | 11.034 |
| 1 / 1750 | 4.581 | 6.052 | 8.934 | 8.935 |
| 1 / 597 | 4.856 | 5.035 | 11.341 | 11.550 |
| 2 / 127 | 4.411 | 5.940 | 9.609 | 9.622 |
| 2 / 3105 | 4.141 | 4.567 | 9.796 | 9.796 |
| 2 / 4046 | 4.065 | 4.165 | 9.310 | 9.722 |
| 3 / 133 | 4.709 | 8.418 | 10.704 | 10.754 |
| 4 / 1697 | 4.370 | 6.647 | 8.485 | 8.776 |
| 4 / 3987 | 4.936 | 5.220 | 10.738 | 10.738 |
